   ...
   public void book(){
        ...
        try {
            ...
            while (rs.next()){
                ...
                for(int i=1; i<=c; i++){
                    ...
                    v2.add(rs.getString("l.retundate"));
                 }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Member Nname", "Book", "BDate", "Return"
            }
        ) {
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(txtbook, 0, 124, Short.MAX_VALUE)
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtbook.addItem(d1.getValueAt(selectIndex, 2).toString());
        txtmember.setText(d1.getValueAt(selectIndex, 4).toString());
    ...
    private void txtidKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtidKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            String mid = txtid.getText();
            try {
                pst = con.prepareStatement("select * from member where idd = ?");
                pst.setString(1, mid);
                rs = pst.executeQuery();
